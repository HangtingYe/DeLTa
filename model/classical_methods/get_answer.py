...
def parse_arguments():
    ...
    parser.add_argument('--base_rule_path', type=str, default='data/adult/prompts',help="Base path for prompt files")
    parser.add_argument('--rule_path', type=str, default='adult_randfull_md20_ml50_tree15.txt',help="Path to the prompt file")
    parser.add_argument('--target_answer_path', type=str, default='data/adult/answer',help="Path to save the results")
